...
interface Props {
    handleSubmit: UseFormHandleSubmit<FormInputs, undefined> /* Estos address eran FormInputs */
    onSubmit: (data: FormInputs) => Promise<void>
    register: UseFormRegister<FormInputs>
    validatedCodigoPostal: () => Promise<void>
    isLoadingPostalCode: boolean
    isErrorPostalCode: boolean
    isCheckPostalCode: boolean
    userStoreAddress: Partial<Address>
    colonias: never[]
    countries: Country[]
    btnTitle: string
    isAddressCheckout: boolean
    iconBtn: boolean
}
