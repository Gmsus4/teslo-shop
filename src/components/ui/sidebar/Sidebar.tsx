...
export const Sidebar = () => {
  ...
  return (
    <div className={`${isSideMenuOpen ? '' : 'hidden'} z-[99999]`}>
      {/* Background black */}
      {isSideMenuOpen && (
      ...
      <nav
        ...
        className={clsx(
          "fixed p-5 right-0 top-0 md:w-[500px] w-[85%] h-screen bg-white z-20 shadow-2xl transform transition-all duration-300",
          {
